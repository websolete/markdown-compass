...
- `markdownNavigator.previewTheme`: Choose the visual theme for markdown previews from 11 available options:
  - Light themes: default, github, academic, minimal, light-modern, light-sepia, light-technical 
  - Dark themes: dark-enhanced, dark-vibrant, dark-elegant, dark-technical
