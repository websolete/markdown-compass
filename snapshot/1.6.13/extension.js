...
async function applyMarkdownTheme(context, themeName = null) {
    try {
        ...
        const filteredStyles = currentStyles.filter(style => {
            if (typeof style === 'string') {                    // Remove any data URIs that contain our theme identifiers
                if (style.startsWith('data:text/css')) {
                    ...
                    return !decoded.includes('/* GitHub-style Markdown Theme */') &&
                        ...
                        !decoded.includes('/* Light Modern Theme */') &&
                        !decoded.includes('/* Light Sepia Theme */') &&
                        !decoded.includes('/* Light Technical Theme */') &&
                        !decoded.includes('/* Dark Vibrant Theme */') &&
                        !decoded.includes('/* Dark Elegant Theme */') &&
                        !decoded.includes('/* Dark Technical Theme */');
                }
                ...
                return !style.includes('markdown-navigator') &&
                    ...
                    !style.includes('light-modern.css') &&
                    !style.includes('light-sepia.css') &&
                    !style.includes('light-technical.css') &&
                    !style.includes('dark-vibrant.css') &&
                    !style.includes('dark-elegant.css') &&
                    !style.includes('dark-technical.css') &&
        ...
        if (customCssPath && customCssPath.trim()) {
            ...
            if (!fs.existsSync(themeStylePath)) {
                ...
                let cssContent = ''; switch (currentTheme) {
                    case 'github':
...
h2 { font-size: 1.75em; border-bottom: 2px solid #edf2f7; padding-bottom: 0.3em; }
...
h1 { font-size: 2.4em; margin-top: 0; border-bottom: 1px solid #e0d6c8; padding-bottom: 0.2em; }
h2 { font-size: 1.8em; border-bottom: 1px solid #e0d6c8; padding-bottom: 0.1em; }
h3 { font-size: 1.5em; }
p { margin-bottom: 24px; }
code {
...
a { color: #996633; text-decoration: none; border-bottom: 1px solid #d9c8b4; }
a:hover { border-bottom-color: #996633; }
blockquote {
    font-style: italic;
    margin-left: 0;
    padding-left: 24px;
    border-left: 4px solid #d9c8b4;
    color: #7d6045;
}`;
                        break;
                    case 'light-technical':
                        cssContent = `/* Light Technical Theme */
body {
...
h1 { font-size: 2em; color: #0366d6; margin-top: 0; }
h2 { font-size: 1.6em; border-bottom: 1px solid #eaecef; padding-bottom: 0.3em; }
h3 { font-size: 1.4em; color: #444d56; }
h4 { font-size: 1.2em; }
...
h1 { font-size: 2.4em; color: #f6ad55; padding-bottom: 0.3em; border-bottom: 2px solid #2d3748; }
h2 { font-size: 1.8em; color: #68d391; border-bottom: 1px solid #2d3748; padding-bottom: 0.2em; }
h3 { font-size: 1.5em; color: #63b3ed; }
h4 { font-size: 1.25em; color: #76e4f7; }
...
a:hover { color: #63b3ed; text-decoration: underline; }
blockquote {
...
h1 { font-size: 2.2em; color: #ffffff; margin-top: 0; }
h2 { font-size: 1.7em; border-bottom: 1px solid #333333; padding-bottom: 0.3em; }
h3 { font-size: 1.4em; color: #9ca3af; }
p { margin-bottom: 20px; line-height: 1.8; }
code {
...
th {
    ...
    color: #f3f4f6;
                        ...
                        break;
                    case 'dark-technical':
                        cssContent = `/* Dark Technical Theme */
body {
...
h1 { font-size: 2em; color: #cf8e6d; border-bottom: 1px solid #3e3e3e; padding-bottom: 0.3em; }
h2 { font-size: 1.6em; color: #499cd5; border-bottom: 1px solid #3e3e3e; padding-bottom: 0.2em; }
h3 { font-size: 1.4em; color: #6fafde; }
h4 { font-size: 1.2em; color: #bbb529; }
...
.function-name { color: #ffc66d; }
a { color: #499cd5; text-decoration: none; }
a:hover { text-decoration: underline; color: #6fafde; }
blockquote {
    border-left: 3px solid #499cd5;
    margin: 16px 0;
    padding: 0 16px;
    color: #9e9e9e;
}
